               ...
               if(index%2===1){
                    return(
                        <Link to={`/movie-detail/${val.link}`}>
                            <div className="col s10 offset-s1 white not-square2" style={{marginTop:"5%", padding:10}}>
                                ...
                                <div className="col s8">
                                    <p className="sideText black-text" style={{fontSize:'20px', marginTop:0, marginBottom:10}}>
                                        <b>{val.title}</b>
                                    </p>
